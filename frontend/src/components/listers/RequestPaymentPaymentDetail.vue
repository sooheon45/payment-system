<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Date label="ApprovalDate" v-model="item.approvalDate" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="RefunedDate" v-model="item.refunedDate" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
